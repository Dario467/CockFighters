...
async function iniciarJuego() {
    try {
        await conectarDB(); 
        console.log("BD Conectada. Buscando luchadores...");

        const datosGallo1 = await ModeloGallo.findOne({});
        const datosGallo2 = await ModeloGallo.findOne({});

        if (!datosGallo1 || !datosGallo2) {
            console.error("¡ERROR! No encontré a uno de los gallos en la BD.");
            return;
        }
    ...
    2);
        ...
        console.log("Datos cargados. ¡Iniciando loop del juego!");
